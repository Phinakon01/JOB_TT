<?php
    ...
    if(isset($_POST['btn1'])){
        $mm = $_POST["mm"];
        $in = '<div class="alert alert-danger">'.$mm.' (mm) เป็น '.($mm * 0.0393700787).' (in)</div>';
    }
    if(isset($_POST['btn2'])){
        header('Location:in&mm.php');
    }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>มิลลิเมตร เป็น นิ้ว</title>
</head>
<body>
    <?php require('./nav.php') ?>
    <div class="container text-center">
            <div class="row">
                ...
                <div class="col-6 border rounded mt-2 p-2 ">
                    <form method="post">
                    <h3>มิลลิเมตร(mm) เป็น นิ้ว(in)</h3>
